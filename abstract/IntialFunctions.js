...
loadOptimalDatas = function() {
	...
	settingsData.load({params:{xml:_donate('Settings', 'SELECT', 'Settings', 'name,value,descr', 's,s,s', " WHERE type=1 and (userCode='"+module+"' or userCode='"+logged+"') ORDER by userCode")}, callback: function() {			
